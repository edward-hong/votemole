...
const PrivacyPolicy = () => (
  <Container fluid>
    ...
    <p>
      ...
      https://votemole.herokuapp.com website (the "Service").
    </p>
    <p>
    ...
    <p>
      ...
      accessible from https://votemole.herokuapp.com
    </p>
    ...
    <p>
      VoteMole will take all steps reasonably necessary to ensure that your data
    ...
    <p>
      VoteMole may disclose your Personal Data in the good faith belief that
